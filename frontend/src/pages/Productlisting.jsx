  ...
  return (
    ...
    >
      <div className="layout-container flex h-full grow flex-col">
        {/* TopNavBar */}
        <header
          className="flex items-center justify-between whitespace-nowrap border-b border-solid px-4 sm:px-6 lg:px-10 py-3"
          style={{
        ...
        >
          <div className="flex items-center gap-8">
            <div
              ...
              style={{
                color: col("#1F2937", "#fff"), // gray-800 dark:white
              }}
            >
              <div
            ...
            <nav className="hidden md:flex items-center gap-9">
              <a
                ...
                style={{
                  color: col("#374151", "#D1D5DB"), // gray-700 dark:gray-300
                }}
                href="#"
              >
                Home
          ...
          <div className="flex flex-1 justify-end items-center gap-4">
            <label className="hidden sm:flex flex-col min-w-40 !h-10 max-w-64">
              <div className="flex w-full flex-1 items-stretch rounded-lg h-full">
                ...
                <input
                  className="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-lg focus:outline-0 focus:ring-0 border-none h-full px-4 rounded-l-none border-l-0 pl-2 text-sm font-normal leading-normal"
                  style={{
            ...
            <div className="flex gap-2">
              <button
                className="flex max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-10 w-10"
                style={{
                  background: col("#F3F4F6", "#1F2937"),
                  color: col("#1F2937", "#E5E7EB"),
                }}
